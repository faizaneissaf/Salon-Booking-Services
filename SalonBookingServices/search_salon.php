	...
	<section class="hero-wrap js-fullheight" style="background-image: url(images/bg-2.jpg);" data-stellar-background-ratio="0.5">
      ...
      var customLabel = {
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('http://localhost/SalonBookingServices1/xml.php', function(data) {
  	...
  	<!-- <div class="container">
          ...
          <!-- <div class="row h-12"> -->
          	<div class="col-md-12 text-center">
          		<p>
          			Copyright jjjj &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Salon Booking Service</a></p>
          			<!-- </div> -->
          		</div>
