		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="user_my_appointments.php#block_saloon" class="nav-link">Blocked Saloon</a></li>
					<li class="nav-item"><a href="user_my_appointments.php#block_staff" class="nav-link">Blocked Staff</a></li>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="search_salon.php"  method="Post">
						...
						<?php
    					$query  = "SELECT * FROM `salon_services` WHERE `service_type`='female' order by `ss_name` ASC";
    					...
    					if (mysqli_num_rows($res)>0) {
							...
							<div class="form-check">
				  				<input class="form-check-input" type="checkbox" value="<?php echo $res2['ss_id'] ?>" id="w_facial" name="services[]">
								<label class="form-check-label" for="w_facial">
									<?php echo $res2['ss_name'] ?>
								</label>
							</div>
						...
						<div id="male_box" class="data">
								...
								<?php
    					$query  = "SELECT * FROM `salon_services` WHERE `service_type`='male'  order by `ss_name` ASC";
