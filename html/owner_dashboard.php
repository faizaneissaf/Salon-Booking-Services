          ...
          <table class="table">
            ...
            <tbody>
              ...
              {?>
                ...
                <td><a href="owner_dashboard.php?deletestaff_req=<?php echo $row['s_id']; ?>" class="btn btn-light btn-outline-danger" >Remove</a>&nbsp<a href="owner_dashboard.php?blockstaffid=<?php echo $row['s_id']; ?>" class="btn btn-primary" >Block</a></td>
                </tr>
              <?php } ?>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              {?>
                ...
                <td><a href="owner_dashboard.php?deleteservice_req=<?php echo $row['ss_id']; ?>" class="btn btn-light btn-outline-danger" >Delete</a></td>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title mb-0">Blocked Staff</h5>
          </div>
          <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <?php
              $sid=$_SESSION['salon_id'];
              $res=mysqli_query($conn,"SELECT * FROM `owner_staff` where salon_id=$sid and active_status=3");
              while($row=mysqli_fetch_array($res))
              {?>
                <tr>
                <td><?php echo $row["s_id"];?></td>
                ...
                <td><a href="owner_dashboard.php?unblockstaffid=<?php echo $row['s_id']; ?>" class="btn btn-primary" >UnBlock</a></td>
                </tr>
              <?php } ?>
